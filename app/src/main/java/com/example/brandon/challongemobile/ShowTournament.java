...
public class ShowTournament extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if(((String)getIntent().getExtras().get("Domain")).equals(""))
            webview.loadUrl("http://challonge.com/" + getIntent().getExtras().get("URL") + "/module?show_final_results=1&show_standings=1");
        else
            webview.loadUrl("http://" + getIntent().getExtras().get("Domain") + ".challonge.com/" + getIntent().getExtras().get("URL") + "/module?show_final_results=1&show_standings=1");
    }
